...
<body>
    ...
    <section id="mainSection">
        ...
        <c:forEach var='jeju' items="${ map.jeju }">
        	<div class='jejuContnet'>
	            <div class="sights btnOpen">
	                <div  class="sightsImg">
	                    <img src="${ jeju.thumbnail }" alt="관광지 이미지">
	                </div>
        ...
        <c:forEach var='seogwipo' items="${ map.seogwipo }">
	        <div class='seogwipoContnet'>
	            <div class="sights btnOpen">
	                <div  class="sightsImg">
...
<%--     확인용
    <div>
    	<c:forEach var="sights" items="${ map.jeju }">
    	제주 : ${ sights.addr }
    	</c:forEach>
    </div>
    <br>
    <div>
    	<c:forEach var="sights" items="${ map.seogwipo }">
    	서귀포 : ${ sights.addr }
    	</c:forEach>
    </div>
    <br>
